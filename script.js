...
alert("Masukkan makanan contoh: 100 g apple");
...
if(result) result.innerHTML="Data tidak ditemukan";
...
datasets:[{
data:[stats.cal,stats.fat,stats.protein,stats.carbs]
}]
}
...
if(result) result.innerHTML="Error: "+e.message;
